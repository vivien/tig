...
*tree*, *blob*, *blame*, *branch*, *stash*, *remote*, *grep* and *generic*.
Use *generic* to set key mapping in all keymaps.
...
|toggle-refs             |Toggle reference display (tags/branches)
|toggle-changes          |Toggle local changes display in the main view
|toggle-sort-order       |Toggle ascending/descending sort order
|toggle-sort-field       |Toggle field to sort by
|toggle-ignore-space     |Toggle ignoring whitespace in diffs
|toggle-commit-order     |Toggle commit ordering
|toggle-id               |Toggle commit ID display
|toggle-files            |Toggle file filtering
|toggle-title-overflow   |Toggle highlighting of commit title overflow
|toggle-file-size        |Toggle file size format
|toggle-untracked-dirs   |Toggle display of files in untracked directories
|toggle-vertical-split   |Toggle vertical split
|=============================================================================
