...
Improvements:
 ...
 - Introduce the remote view, bound to the 'T' keybinding.
 ...
 - Copy `-S<search-string>` to search buffer so `find-next` works as expected.
...
Bug fixes:
 ...
 - Disable graph drawing for reverse log order and `tig -Ssearch`. (GH #127)
